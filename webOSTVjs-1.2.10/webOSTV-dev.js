window.webOSDev = (function (e) {
  ...
  function (e, r, t) {
    ...
    var s = {},
      ...
      d = function (e) {
        var r = e.id,
          ...
          s = { id: t, params: o };
        f.BROWSER === t &&
          ((s.params.target = o.target || ""),
          (s.params.fullMode = !0),
          (s.id = "com.webos.app.browser")),
          (function (e) {
            var r = e.parameters,
              t = e.onSuccess,
              n = e.onFailure;
    ...
    var S = {
      ...
      w = { PLAYREADY: "playready", WIDEVINE: "widevine" },
      P = 0,
      j = 1,
      T = 2,
      E = 3,
              ...
              value: function (e) {
                ...
                if (R(this)) {
                  var a = (function (e) {
                    ...
                    s = y({ clientId: this.clientId, msg: n }, a);
                  D({
