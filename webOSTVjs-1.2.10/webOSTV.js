window.webOS = (function (e) {
  ...
  function (e, t, n) {
          ...
          (n = [
            {
              ...
              value: function (e) {
                ...
                return (
                  (this.subscribe = b),
                  this.subscribe && (w.subscribe = this.subscribe),
                  w.subscribe && (this.subscribe = w.subscribe),
                  (this.ts = Date.now()),
                  (p[this.ts] = this),
    ...
    if (
      ...
      if (window.navigator.userAgent.indexOf("SmartWatch") > -1) g.watch = !0;
        ...
        try {
          ...
          if (w.platformVersionMajor && w.platformVersionMinor) {
            var h = Number(w.platformVersionMajor),
              O = Number(w.platformVersionMinor);
            h < 3 || (3 === h && O <= 0) ? (g.legacy = !0) : (g.open = !0);
          }
        } catch (e) {
          g.open = !0;
        }
      ...
      if (
        ...
        var S =
          ...
          V = window.navigator.userAgent.slice(S).indexOf(" "),
          j = window.navigator.userAgent.slice(S + 7, S + V).split(".");
        g.chrome = Number(j[0]);
      } else g.chrome = 0;
    } else g.unknown = !0;
    var k = g,
    ...
    function _(e) {
      P.soundOutput &&
      0 === P.soundOutput.indexOf("external_arc") &&
      "external_arc_sound_alive" !== P.soundOutput
        ? e(!0)
        : !P.soundOutput ||
          (0 !== P.soundOutput.indexOf("tv_") &&
            "external_arc_sound_alive" !== P.soundOutput)
        ? e(null)
        : e(!1);
    }
    function N(e) {
      "auto" === P.soundOutputDigital || "passThrough" === P.soundOutputDigital
        ? e(!0)
        : e(!1);
    }
    function z(e, t) {
      T.dolbyAtmos !== e && ((T.dolbyAtmos = e), (D = !0), M(t));
    }
    function B(e) {
      !(function (e) {
        T.sdkVersion && e(T.sdkVersion.split(".")),
          new v().send({
            service: "luna://com.webos.service.tv.systemproperty",
            method: "getSystemInfo",
            parameters: { keys: ["sdkVersion"] },
            onSuccess: function (t) {
              (T.sdkVersion = t.sdkVersion || T.sdkVersion),
                e(T.sdkVersion.split("."));
            },
            onFailure: function () {
              e([0, 0, 0]);
            },
          ...
          ? new v().send({
              ...
              onComplete: function (t) {
                _(function (n) {
                  (n ||
                    (!P.dolbyAtmosConfig &&
                      "tv_speaker_external_arc_harmony" === P.soundOutput)) &&
                    N(function (n) {
                      z(!!n && t.returnValue && "ATMOS" === t.arcProfile, e);
                    });
                });
              },
              onFailure: function () {
                console.log("[webOSTV.js] getARCState failed"), z(!1, e);
              },
            })
          : new v().send({
              ...
              onComplete: function (t) {
                _(function (n) {
                  (!n &&
                    (P.dolbyAtmosConfig ||
                      ("tv_speaker_external_arc_harmony" !== P.soundOutput &&
                        void 0 !== P.soundOutput))) ||
                    N(function (n) {
                      z(!!n && t.returnValue && !0 === t.atmosDevice, e);
                    });
                });
              },
              onFailure: function () {
                console.log("[webOSTV.js] getAllInputStatus failed"), z(!1, e);
              },
            });
      });
    }
    function R(e) {
      void 0 === P.dolbyAtmosConfig
        ? new v().send({
            ...
            onComplete: function (t) {
              (P.dolbyAtmosConfig = t.configs
                ? t.configs["tv.config.supportDolbyTVATMOS"] ||
                  "Dolby Atmos" === t.configs["tv.model.soundModeType"]
                : "failure"),
                R(e);
            },
          })
        : !0 === P.dolbyAtmosConfig
        ? z(!0, e)
        : !1 === P.dolbyAtmosConfig
        ? "tv_speaker_external_arc_harmony" === P.soundOutput
          ? N(function (t) {
              t ? B(e) : z(!1, e);
            })
          : void 0 === P.soundOutput
          ? (console.log("[webOSTV.js] soundOutput value is", P.soundOutput),
            B(e))
          : z(!1, e)
        : (console.log("[webOSTV.js] dolbyAtmos config is", P.dolbyAtmosConfig),
          z(!1, e));
    }
    function E(e) {
      new v().send({
        ...
        onComplete: function (t) {
          if (t.configs) {
            if (
              ((T.modelName = t.configs["tv.model.modelname"] || T.modelName),
              (t.configs["tv.nyx.firmwareVersion"] &&
                "0.0.0" !== t.configs["tv.nyx.firmwareVersion"]) ||
                (t.configs["tv.nyx.firmwareVersion"] =
                  t.configs["tv.nyx.platformVersion"]),
              t.configs["tv.nyx.firmwareVersion"])
            ) {
              ...
              for (
                ...
                try {
                  T[o[r]] = parseInt(n[r], 10);
                } catch (e) {
                  T[o[r]] = n[r];
                }
            }
            (T.sdkVersion =
              t.configs["tv.nyx.platformVersion"] || T.sdkVersion),
              (T.uhd =
                "UD" === t.configs["tv.hw.panelResolution"] ||
                "8K" === t.configs["tv.hw.panelResolution"]),
              (T.uhd8K =
                "8K" === t.configs["tv.hw.panelResolution"] ||
                !0 === t.configs["tv.model.supportTemp8K"]),
              (T.oled = "OLED" === t.configs["tv.hw.displayType"]),
              (T.ddrSize = t.configs["tv.hw.ddrSize"]),
              (T.hdr10 = !0 === t.configs["tv.model.supportHDR"]),
              (T.dolbyVision =
                !0 === t.configs["tv.config.supportDolbyHDRContents"]),
              (T.brandName = t.configs["tv.model.TVBrandName"] || T.brandName),
              (T.manufacturer =
                t.configs["tv.model.TVManufacturer"] || T.manufacturer),
              (T.mainboardMaker = t.configs["tv.model.mainboardMaker"]),
              t.configs["wee.platformBizType"]
                ? (T.platformBizType = t.configs["wee.platformBizType"])
                : "WEE" === t.configs["com.webos.app.home.uiStyle"] &&
                  (T.platformBizType = "wee"),
              t.configs["profile.list"]
                ? (T.tuner = !t.configs["profile.list"].includes("tunerless"))
                : t.configs["com.webos.service.utp.supportTunerless"] &&
                  (T.tuner = !1);
          }
          !t.returnValue ||
          (function (e) {
            ...
            ? (function (e) {
                new v().send({
                  ...
                  onComplete: function (t) {
                    if (
                      ((T.modelName = t.modelName || T.modelName),
                      (T.sdkVersion = t.sdkVersion || T.sdkVersion),
                      (T.uhd = t.UHD ? "true" === t.UHD : T.uhd),
                      (T.oled = t.OLED ? "true" === t.OLED : T.oled),
                      (T.ddrSize = t.ddrSize || T.ddrSize),
    ...
    var I = function (e) {
        !(function (e) {
          new v().send({
            ...
            onSuccess: function (t) {
              t.settings
                ? ((P.soundOutput = t.settings.soundOutput || P.soundOutput),
                  (P.soundOutputDigital =
                    t.settings.soundOutputDigital || P.soundOutputDigital),
                  t.settings.soundOutput
                    ? ((P.soundOutput = t.settings.soundOutput),
                      _(function (t) {
                        t
                          ? N(function (t) {
                              t ? B(e) : z(!1, e);
                    ...
                    : t.settings.soundOutputDigital &&
                      _(function (t) {
                        (t ||
                          ("tv_speaker_external_arc_harmony" ===
                            P.soundOutput &&
                            !0 !== P.dolbyAtmosConfig)) &&
                          N(function (t) {
                            t ? B(e) : z(!1, e);
            ...
            : ((x = !0),
              (function () {
                try {
                  ...
                  (T.modelName = e.modelName),
                    (T.version = e.platformVersion),
                    (T.versionMajor = e.platformVersionMajor),
                    (T.versionMinor = e.platformVersionMinor),
                    (T.versionDot = e.platformVersionDot),
                    (T.screenWidth = e.screenWidth),
                    (T.screenHeight = e.screenHeight);
                } catch (e) {
                  T.modelName = "webOS Device";
                }
                (T.screenHeight = T.screenHeight || window.screen.height),
                  (T.screenWidth = T.screenWidth || window.screen.width);
              })(),
              k.tv
                ? ((T.uhd = !1),
                  (T.uhd8K = !1),
                  ...
                  (T.dolbyVision = !1),
                  (T.brandName = "LG"),
                  (T.manufacturer = "LG Electronics"),
                  (T.platformBizType = "LG"),
                  (T.tuner = !0),
                  E(e))
                : ((A = !0), M(e)));
      },
      ...
      L = function () {
        ...
        if (window.PalmSystem) {
          if (window.PalmSystem.country) {
            ...
            (e.country = t.country),
              (e.smartServiceCountry = t.smartServiceCountry);
          }
